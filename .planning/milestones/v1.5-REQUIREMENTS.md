# Requirements Archive: v1.5 Chat & Profile
...
- [x] **CHAT-01**: User can react to any message with one of 6 preset emojis (tapback style)
- [x] **CHAT-02**: User can remove their own reaction by tapping it again (toggle off)
- [x] **CHAT-03**: Reaction counts display inline below the message bubble, grouped by emoji
