...
- [x] 32-02-PLAN.md — Last-entry preview UI: refactor ChatListRow preview composition with Ionicon + sender prefix + italic-for-deleted (Wave 2, depends on 32-01)
...
- [x] 33-02-PLAN.md — Data hooks: useFriendProfile (shared status slice + friend-not-found via friendships row) + useFriendMutuals (Wave 2, depends on 01)
- [x] 33-03-PLAN.md — Header components: AvatarCircle onLoad pass-through + FriendProfileBlurredWash + FriendProfileHeader (Reanimated v4 scroll-driven collapse) (Wave 1)
...
- [x] 33-06-PLAN.md — Screen rewrite + photos route + useChatDmPreferences + screen test + manual hardware smoke checkpoint (Wave 3, depends on 01+02+03+04+05)
