...
- [ ] 29.1-05-PLAN.md — Habits feature surfaces: /squad/habits/* routes + 5 components (HabitRow, HabitCadencePicker, HabitMemberStrip, HabitCheckinHistory, HabitInvitationRow)
- [ ] 29.1-06-PLAN.md — To-Dos feature surfaces: /squad/todos/* routes + 3 components (TodoRow, ChatTodoListRow, TodoQuickAdd)
- [ ] 29.1-07-PLAN.md — Chat integration: ChatTodoPickerSheet + ChatTodoBubble + SystemMessageRow + MessageBubble render branches + ChatRoomScreen wire-up
