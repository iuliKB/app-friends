...
- [ ] **AUTH-01**: User can reset their password via an email link from the login screen
- [ ] **AUTH-02**: Sign-up screen shows visible Terms of Service and Privacy Policy links
