...
import { STATUS_CARD_TOKENS, STATUS_DATA, type StatusKey } from './statusCardTokens';
          ...
          <View pointerEvents="none" style={styles.bloomTopLeft}>
            <Svg width={110} height={110}>
              ...
              <Rect
                ...
                width={110}
                height={110}
                fill={`url(#bloomTL-${themeKey}-${status})`}
              />
            </Svg>
          </View>
          ...
          <View pointerEvents="none" style={styles.bloomBottomRight}>
            <Svg width={100} height={100}>
              ...
              <Rect
                ...
                width={100}
                height={100}
                fill={`url(#bloomBR-${themeKey}-${status})`}
              />
            </Svg>
          </View>
        </>
      ...
      <View style={styles.topRow}>
        ...
        <View style={styles.chip}>
          <View style={styles.chipDotWrap}>
            <Animated.View
              style={[styles.chipRing, { transform: [{ scale: ringScale }], opacity: ringOpacity }]}
              pointerEvents="none"
            />
            <Animated.View
              style={[styles.chipDot, { transform: [{ scale: dotScale }], opacity: dotOpacity }]}
            />
          </View>
