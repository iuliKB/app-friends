...
const STD_LOCATIONS: [number, number, number, number] = [0, 0.35, 0.7, 1];

// ---------- DARK ----------
const dark: Record<StatusKey, StatusCardTokens> = {
  free: {
    gradient: {
      colors: ['#0f2417', '#1a3528', '#2e4a1a', '#1a2010'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
  ...
  maybe: {
    gradient: {
      colors: ['#241a07', '#352a0e', '#4a3a14', '#201b0c'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
    ...
    chip: {
      ...
      dot: '#FACC15',
      useBackdropBlur: false,
      pulseDotHaloColor: '#FACC15',
    },
    title: {
      color: '#FFFFFF',
      textShadow: { color: 'rgba(250,204,21,0.22)', radius: 24, offsetY: 2 },
    },
    bodyText: 'rgba(255,255,255,0.7)',
    pencil: 'rgba(255,255,255,0.7)',
  },
  busy: {
    gradient: {
      colors: ['#240f0f', '#3a1818', '#4a2020', '#201010'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
    ...
    chip: {
      ...
      dot: '#F87171',
      useBackdropBlur: false,
      pulseDotHaloColor: '#F87171',
    },
    title: {
      color: '#FFFFFF',
      textShadow: { color: 'rgba(248,113,113,0.22)', radius: 24, offsetY: 2 },
    },
    bodyText: 'rgba(255,255,255,0.7)',
    pencil: 'rgba(255,255,255,0.7)',
  },
  inactive: {
    gradient: {
      colors: ['#15171a', '#1d2027', '#23262d', '#16181b'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
...
const light: Record<StatusKey, StatusCardTokens> = {
  free: {
    gradient: {
      colors: ['#eaf5ec', '#d9ecdb', '#e8f0c9', '#f1f3df'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
  ...
  maybe: {
    gradient: {
      colors: ['#f7eed1', '#f1e2a8', '#ede1c0', '#f5f0d6'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
  ...
  busy: {
    gradient: {
      colors: ['#fbe6e6', '#f5cfcf', '#f3d3d3', '#f8e0e0'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
  ...
  inactive: {
    gradient: {
      colors: ['#f1f2f5', '#e8eaee', '#eceef2', '#f3f4f7'],
      locations: STD_LOCATIONS,
      ...GRADIENT_120_DEG,
    },
